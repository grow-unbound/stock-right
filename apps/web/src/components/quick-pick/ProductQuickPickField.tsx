...
import { ProductSearchOverlay } from "@/components/stock/add-lot/ProductSearchOverlay";
import { ProductQuickPickList } from "./ProductQuickPickList";
import { useProductQuickPick } from "./useProductQuickPick";

interface ProductQuickPickFieldProps {
  label: string;
  labelClassName: string;
  warehouseId: string;
  supabase: SupabaseClient;
  value: ProductPickRow | null;
  onChange: (row: ProductPickRow) => void;
  placeholder?: string;
}

export function ProductQuickPickField({
  label,
  labelClassName,
  warehouseId,
  supabase,
  ...
  const committedLabel = value ? value.product_name : "";
